...
> Ragosta A. Glaucoma Clinical Decision Support: Combinatorial Verification of a Modular Rule-Based Architecture for Implementation Fidelity. *JMIR Medical Informatics* (under review, 2026).

A `CITATION.cff` file is provided for tools that read Citation File Format.

A separate module-specific manuscript concerning the M1 Advanced biomechanical pressure-interpretation module (GAT/ORA/Corvis-specific pressure interpretation) is currently under consideration at *Computer Methods and Programs in Biomedicine*. That manuscript addresses an independent in-silico scenario evaluation of the M1 Advanced module and is methodologically distinct from the present repository, which documents the full OFTY Glaucoma Suite architecture, the Module Architecture Standard, M5 orchestration, and combinatorial implementation-fidelity verification.
...
Each module is implemented as a static client-side HTML document that operates entirely in the browser. There is no server-side computation, no server-side transmission or storage of patient data, and no login. Module-to-module transfer of computed outputs, when used, occurs locally in the user's browser through browser-local storage and can be cleared by the user through the in-application controls.

The deployed suite is publicly accessible at: **<https://ofty.vercel.app>**

| Module | URL |
| --- | --- |
| M1 | <https://ofty.vercel.app/glaucoma/iop-cct/> |
| M2 | <https://ofty.vercel.app/glaucoma/target-iop/> |
| M3 | <https://ofty.vercel.app/glaucoma/vf-progression/> |
| M4 | <https://ofty.vercel.app/glaucoma/rnfl-progression/> |
| M5 | <https://ofty.vercel.app/glaucoma/orchestrator/> |
...
Admiravisión Ophthalmology Department
